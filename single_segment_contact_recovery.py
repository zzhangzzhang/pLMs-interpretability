...
with open('selected_gremlin_high_v1/TM_filtered/full_seq_dict.json', "r") as json_file:
    seq_dict = json.load(json_file)

with open('selected_gremlin_high_v1/TM_len_filtered_pro.json', 'r') as file:
...
save_file_path = './single_mask/w_bos_eos.hdf5' 
